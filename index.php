...
<br><small id="emailHelp" class="form-text text-muted">чтобы поставить машину<a href="http://84.201.189.23/uliana/enterUser.php"> авторизируйтесь </a> или <a href="http://84.201.189.23/uliana/regUser.php"> зарегистрируйтесь </a></small>
<div class="dropdown">
